...
import { ArrowLeft, FileText, Loader2, Construction } from "lucide-react";
                    ...
                    <Card className="max-w-2xl mx-auto">
                        ...
                        <CardContent className="space-y-4">
                            <p className="text-muted-foreground">
                                The blog management interface is currently being developed. Soon you'll be able to:
                            </p>
                            <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground">
                                <li>Create, edit, and delete blog posts</li>
                                <li>Add featured images and rich content</li>
                                <li>Organize posts by category</li>
                                <li>Set SEO metadata and descriptions</li>
